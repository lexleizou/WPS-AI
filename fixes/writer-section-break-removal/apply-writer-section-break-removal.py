#!/usr/bin/env python3
"""Install/check/remove the managed Writer section-break tool on all Lingxi plugin copies."""
from __future__ import annotations
import argparse, hashlib, json, os, shutil, subprocess
from datetime import datetime
from pathlib import Path

MARKER = "LINGXI_WRITER_SECTION_BREAK_REMOVAL_V1"
HOST_MARKER, TOOLS_MARKER = MARKER + "_HOST", MARKER + "_TOOLS"
HOST_AFTER, TOOLS_AFTER = '    "js/hosts/writer.js",', '    "js/tools/writer.js",'
HOST_LINE = f'    "js/hosts/writer-section-break.js", // {HOST_MARKER}'
TOOLS_LINE = f'    "js/tools/writer-section-break.js", // {TOOLS_MARKER}'
HOME, ROOT = Path.home(), Path(__file__).resolve().parent
HOST_SOURCE, TOOLS_SOURCE = ROOT / "writer-section-break-host.js", ROOT / "writer-section-break-tools.js"
...
def atomic(path: Path, data: bytes, mode: int | None = None) -> None:
    ...
    temp = path.with_name(path.name + ".tmp-section-break")
...
def backup(operation: str) -> Path:
    ...
    for label, root in ROOTS:
        entries = {}
        for rel in ("main.js", "js/hosts/writer-section-break.js", "js/tools/writer-section-break.js"):
...
def apply() -> int:
    ...
    for _, root, before, after in prepared:
        ...
        atomic(root / "js/hosts/writer-section-break.js", HOST_SOURCE.read_bytes(), 0o644)
        atomic(root / "js/tools/writer-section-break.js", TOOLS_SOURCE.read_bytes(), 0o644)
...
def check() -> int:
    ...
    for label, root in ROOTS:
        main, host, tools = root / "main.js", root / "js/hosts/writer-section-break.js", root / "js/tools/writer-section-break.js"
        text = main.read_text("utf-8") if main.is_file() else ""
...
def remove() -> int:
    ...
    for _, root in ROOTS:
        ...
        for rel in ("js/hosts/writer-section-break.js", "js/tools/writer-section-break.js"):
            path = root / rel
            if path.is_file():
